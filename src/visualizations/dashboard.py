...
from src.visualizations.eda import (
    churn_by_category,
    churn_by_consumption,
    churn_by_nps,
    churn_by_support_tickets,
    churn_by_tenure,
    churn_overview,
    correlation_heatmap,
    margin_vs_churn,
...
def create_layout(df: pd.DataFrame) -> html.Div:
    ...
    return html.Div(
        style={"fontFamily": "Arial, sans-serif", "maxWidth": "1280px", "margin": "0 auto", "padding": "24px"},
        children=[
...
def register_callbacks(app) -> None:
    @app.callback(Output("cat-bar", "figure"), Input("cat-dropdown", "value"), Input("store", "data"))
