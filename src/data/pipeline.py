...
class MultiSourcePipeline:
    def __init__(
        self, client_source=None, price_source=None, crm_source=None, support_source=None, billing_source=None
    ):
